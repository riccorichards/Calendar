...
addEventContent = document.querySelector('.add-event-wrapper'),
...
addEventBtn.addEventListener('click', ()=>{
    addEventContent.classList.toggle('active');
});
addEventCloseBtn.addEventListener('click', () =>{
    addEventContent.classList.remove('active');
});

document.addEventListener('click', (e)=>{
    if(e.target != addEventBtn && !addEventContent.contains(e.target)){
        addEventContent.classList.remove('active')
    }
})
...
addEventSubmit.addEventListener('click', ()=>{
    ...
    const eventTimeFrom = addEventForm.value;
